    	...
    	<div class="col-md-7 col-md-offset-2">
    		<form class="form-horizontal" method="post" action="pengambilan_simpan.php">
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="jumlah pengambilan" placeholder="Nama yang Mengambil Pesanan" name="nama_pengambil">
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="jumlah pengambilan" placeholder="Jumlah Pengambilan Barang dalam angka" name="jumlah_pengambilan">
                    </div>
                </div>
                <br>
