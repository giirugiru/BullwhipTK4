    	...
    	<div class="col-md-7 col-md-offset-2">
    		<form class="form-horizontal" method="post" action="pesanan_simpan.php">
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="Nama Pemesan" placeholder="Nama atau Instansi Pemesan" name="nama_pemesan">
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<select required class="form-control" name="id_barang" id="nama_barang">
                          	<option value="">----- Nama Barang Pesanan -----</option>
                            	<?php
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="jumlah pesanan" placeholder="Jumlah Pesanan Barang dalam angka" name="jumlah_pesanan">
                    </div>
                </div>
                <br>
