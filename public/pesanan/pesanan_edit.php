...
<div class="container-fluid">
    	<div class="col-md-7 col-md-offset-2">
    		<form class="form-horizontal" method="post" action="pesanan_update.php">
                ...
                <input required type="text" name="id_pesanan" value="<?php echo $value['id_pesanan'] ?>">

                <div class="form-group">
                	<label for="nama_pemesan" class="col-md-3"> Nama pemesan  </label>
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="nama_pemesan" name="nama_pemesan" value="<?php echo $value['nama_pemesan']; ?>">
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="jumlah_barang" name="jumlah_barang" value="<?php echo $value['jumlah_pesanan']; ?>">
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="jumlah_produksi" placeholder="Jumlah Produksi" name="jumlah_produksi">
                    </div>
                </div>
                <br>
