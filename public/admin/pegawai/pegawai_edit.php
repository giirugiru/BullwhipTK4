    	...
    	<div class="col-md-7 col-md-offset-2">
    		<form class="form-horizontal" method="post" action="pegawai_update.php">
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="username" name="username" value="<?php echo $value['username']; ?>">
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="nama pegawai" name="nama_pegawai" value="<?php echo $value['nama_pegawai']; ?>">
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="alamat pegawai" name="alamat_pegawai" value="<?php echo $value['alamat_pegawai']; ?>">
                    </div>
                </div>
                <br>
                ...
                <div class="form-group">
                	...
                	<div class="col-md-7">
                    	<input required type="text" class="form-control" id="hp_pegawai" name="hp_pegawai" value="<?php echo $value['hp_pegawai']; ?>">
                    </div>
                </div>
                <br>
