...
<h2 class="form-signin-heading" align="center">Silakan Login Dahulu</h2>
    ...
    <div class="col-md-6 col-md-offset-3">
    	<input required type="text" class="form-control" placeholder="Masukkan Username Anda" name="username" required>
    </div>

    <label for="Username" class="col-md-6 col-md-offset-3"> Password </label>
    <div class="col-md-6 col-md-offset-3">
    <input required type="password" class="form-control" placeholder="MasukkanPassword Anda" name="password" required>
    </div>
    <br>
