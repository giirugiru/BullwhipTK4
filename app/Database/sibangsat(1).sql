...
/*NEW QUERY ADDED TO HANDLE LOGIN BUGS*/
UPDATE `pegawai` SET `id_bagian` = '7' WHERE `pegawai`.`id_pegawai` = 7;
UPDATE `pegawai` SET `id_bagian` = '10' WHERE `pegawai`.`id_pegawai` = 11;
